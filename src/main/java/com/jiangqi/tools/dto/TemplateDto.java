...
public abstract class TemplateDto implements IDto {
	...
	private List<String> checkValid(String name) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSubClassException{
	...
	public List<String> checkValid() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSubClassException{
	...
	public List<String> checkValid(List<String> paramArrayOfString) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSubClassException{
	...
	public List<String> checkValidExcept(List<String> paramArrayOfString)throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSubClassException{
	...
	private IDto getIDto(String name,Object obj) throws IntrospectionException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
	...
	private void getListIDto(List<IDto> list,String name,Object obj) throws IntrospectionException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
	...
	private List<IDto> getAllSon() throws Exception{
		...
		for (int i = 0; i < field.length; i++) {
			if (field[i].getModifiers() == Modifier.PRIVATE) {
				...
				if (field[i].getType() == Class.forName(BeanConvert.ListName)) {
					Class<?> genericClass;
